...
<html lang="en">
  <head>
    ...
    <title>Hello, dicoding!</title>
  </head>
  <body>
    <div class="alert alert-primary" role="alert">
  Submission II Dicoding By RahmanSaputra
</div>
<div class="jumbotron">
  ...
  <a class="btn btn-primary btn-lg" href="http://mydicoding.azurewebsites.net/cvision.php" role="button">Go Vision</a>
</div>
    <!-- Optional JavaScript -->
